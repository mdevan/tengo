...
- create a [Script](https://godoc.org/github.com/mdevan/tengo#Script) instance with
your code,
- _optionally_ add some
[Script Variables](https://godoc.org/github.com/mdevan/tengo#Variable) to Script,
- compile or directly run the script,
- retrieve _output_ values from the
[Compiled](https://godoc.org/github.com/mdevan/tengo#Compiled) instance.

The following is an example where a Tengo script is compiled and run with no
input/output variables.

```golang
import "github.com/mdevan/tengo/v2"
...
[Variable.Int](https://godoc.org/github.com/mdevan/tengo#Variable.Int) function:
...
[Script.Add](https://godoc.org/github.com/mdevan/tengo#Script.Add) function. Then a
...
using [Compiled.Get](https://godoc.org/github.com/mdevan/tengo#Compiled.Get)
function. See
[documentation](https://godoc.org/github.com/mdevan/tengo#Variable) for the
full list of variable value functions.

Value of the global variables can be replaced using
[Compiled.Set](https://godoc.org/github.com/mdevan/tengo#Compiled.Set) function.
...
_([Script.Add](https://godoc.org/github.com/mdevan/tengo#Script.Add))_, Script
...
[Object](https://godoc.org/github.com/mdevan/tengo#Object) interface. Tengo runtime
will treat the user types in the same way it does to the runtime types with no
performance overhead. See
[Object Types](https://github.com/mdevan/tengo/blob/master/docs/objects.md) for
more details.
...
[Compiler](https://godoc.org/github.com/mdevan/tengo#Compiler), and
[VM](https://godoc.org/github.com/mdevan/tengo#VM) for yourself instead of using
